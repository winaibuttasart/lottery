...
app.get('/lottery', function(req, res) {
  ...
  async.waterfall([
    ...
    function(LotteryInjsonData) {
      //  console.log(LotteryInjsonData);
      res.send(LotteryInjsonData);
    }
  );
})
  ...
  async.waterfall([
    ...
    function(jsonData) {
      ...
      for (var i = 0; i < tmp.length; i++) {
        ...
        for (var j = 0; j < 10; j++) {
          if (tmp[i] === jsonData['third-prize'][j + 1]) {
